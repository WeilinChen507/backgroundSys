			...
			<div style="padding: 15px;">
				<fieldset class="layui-elem-field layui-field-title">
					...
					<div class="layui-field-box">
			            ...
			            <div style="padding: 15px;">
			             	<div class="layui-field-box">
								<form action="<c:url value='/admin_module/edit_admin' />" charset="utf-8" method="POST" class="layui-form">
									
									<input type="hidden" value="${adminForm.id}" name="id">
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="password" placeholder="请输入管理员密码，必填" autocomplete="off" class="layui-input" name="adminPassword" lay-verify="required|pass">
										</div>
									</div>
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="password" placeholder="请再次输入密码，必填" autocomplete="off" class="layui-input" name="repeatedPassword" lay-verify="required">
										</div>
									</div>
									...
									<div class="layui-input-block">
										...
										<a class="layui-btn layui-btn-normal" href="<c:url value='/admin_module/edit_admin/${adminForm.id }' />">重置</a>
									</div>
								</form>
							</div>
